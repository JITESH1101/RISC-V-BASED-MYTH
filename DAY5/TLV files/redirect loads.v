   ...
   |cpu
      @0
         $reset = *reset;
          // YOUR CODE HERE
         $start = >>1$reset && !$reset;
         $load_stall = >>3$is_load;
         $valid = $reset ? 1'b0 :
                  $start ? 1'b1 :
                  (>>3$valid && !(>>3$valid_taken_br || >>4$valid_taken_br) && !$load_stall);
      ...
      @2 
         ...
         $src1_value[31:0] = (>>1$rf_wr_index == $rf_rd_index1) && >>1$rf_wr_en ? >>1$result :
                             (>>2$rf_wr_index == $rf_rd_index1) && >>2$rf_wr_en ? >>2$rf_wr_data :
                             $rf_rd_data1;
         $src2_value[31:0] = (>>1$rf_wr_index == $rf_rd_index2) && >>1$rf_wr_en ? >>1$result :
                             (>>2$rf_wr_index == $rf_rd_index2) && >>2$rf_wr_en ? >>2$rf_wr_data :
                             $rf_rd_data2;
